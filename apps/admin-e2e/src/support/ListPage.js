export default (url) => ({
  elements: {
    ...
    svg: (name, criteria = '') => `th span[data-field="${name}"] svg${criteria}`,
    logout: '.logout',
    bulkActionsToolbar: '[data-test=bulk-actions-toolbar]',
    customBulkActionsButton: '[data-test=bulk-actions-toolbar] button[aria-label="Reset views"]',
    deleteBulkActionsButton: '[data-test=bulk-actions-toolbar] button[aria-label="Delete"]',
